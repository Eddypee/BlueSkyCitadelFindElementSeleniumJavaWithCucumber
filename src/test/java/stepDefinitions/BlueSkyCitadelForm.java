...
public class BlueSkyCitadelForm {
    ...
    public void iEnterEmailAddress() {
        driver.findElement(By.id("nf-field-124")).sendKeys("myblueskyemailaddress@test.com");
    }

    @And("^I enter password$")
    public void iEnterPassword() {
        driver.findElement(By.name("nf-field-144")).sendKeys("MySecureBlueSkyCetadalePassword");
    }
